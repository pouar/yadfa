...
(defun intro-function ()
  ...
  (let* ((default (make-instance 'player))
    ...
    (setf (player-of *game*) (make-instance 'player
                                            ...
                                            :bowels/need-to-potty-limit (getf '(:normal 400 :low 300 :kid 140) bowels)
                                            :bowels/potty-dance-limit (getf '(:normal 600 :low 450 :kid 210) bowels)
                                            :bowels/potty-desperate-limit (getf '(:normal 700 :low 525 :kid 245) bowels)
                                            :bowels/maximum-limit (getf '(:normal 800 :low 600 :kid 280) bowels)
