...
(defmethod process-battle-turn ((character enemy) attack item reload selected-target)
  ...
  (let ((time-passed (- (time-of *game*) (last-process-potty-time-of character))))
    (incf (bladder/contents-of character) (* (bladder/fill-rate-of character) time-passed 5))
    (incf (bowels/contents-of character) (* (bowels/fill-rate-of character) time-passed 5)))
