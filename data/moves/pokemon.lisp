...
(defclass watersport (stat/move) ()
    (:default-initargs
        ...
        :attack '(lambda (target user self)
                     ...
                     (wet
                         :force-fill-amount (if (< (bladder/contents-of user) (bladder/need-to-potty-limit-of user))
    ...
    (:default-initargs
        ...
        :attack '(lambda (target user self)
                     ...
                     (format t
                         ...
                         (if (malep user) "himself" "herself"))
                     (mess
                         :force-fill-amount (if (< (bowels/contents-of user) (bowels/need-to-potty-limit-of user))
