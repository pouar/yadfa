...
(defevent ironside-university-joke-1
    ...
    :lambda '(lambda (self)
                 (declare (ignore self))
                 (write-line "*Raccoon Diapered Bandit barges in*")
                 (write-line "Raccoon Diapered Bandit: Hey, is this one of those parenting classes that is looking for a live demonstration?")
                 (write-line "Instructor: No")
                 (write-line "Diapered Raccoon Bandit: Great, today I'm going to give you all you aspiring parents a live demonstration on how to change your bab's diaper")
