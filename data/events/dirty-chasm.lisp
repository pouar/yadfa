...
(defevent pointless-quest-1
  :lambda (lambda (self)
            ...
            (out "The author is running out of ideas, so lets add some filler content" :% :%
                 "*Player starts 20 minute power up sequence by standing there screaming*" :% :%
                 "Damn it, that takes up a lot less time in a text based game. Time to bring out the pointless quests" :% :%
