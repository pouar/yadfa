...
(defevent enter-bandits-shop-1
  :lambda '(lambda (self)
            ...
            (out "Rookie Diapered Raccoon Bandit Servant: But I really gotta gooooo!!!!! *hops from foot to foot holding the front of his diaper*")
            (out "*The shop owner walks over to the servant and starts tickling him*")
            (out "Rookie Diapered Raccoon Bandit Servant: NOOOO!!! STOP!!!! I CAN'T HOLD IT!!!!")
            (out "*The rookie starts laughing and thrashing about, the insignia that doubles as a wetness indicator on the front of his diaper then turns from blue to yellow.*")
            (out "Shop Owner: There, you went, now go see to the customer.")
            (out "*The now blushy Rookie Diapered Raccoon Bandit waddles and squishes over to the back of the counter*")))
(defevent enter-bandits-shop-3
  ...
  :lambda '(lambda (self)
            ...
            (out "Shopkeeper: I can't believe I lost the stupid key!!!!!")
            (out "*The shopkeeper turns to you, pressing his knees together bobbing up and down with both paws pressed firmly on the front of his diaper*")
            (out "Shopkeeper: HELP ME!!!!!")
            (out "*" (name-of (player-of *game*)) " shrugs and tickles the shopkeeper*")
            (out "Shopkeeper: NOOOO!!!!!! NOT WHAT I MEANT!!!!!")
            (out "*The shopkeeper laughs and thrashes about and floods his diapers*")
            (out (name-of (player-of *game*)) ": You're welcome")
            (out "*The shopkeeper blushes heavily and grumbles*")))
(defevent enter-bandits-shop-2
  ...
  :lambda '(lambda (self)
            ...
            (out "Raccoon: LET ME IN!!!! I CAN'T HOLD IT MUCH LONGER!!!!")
            (out "Shop Owner: Sorry leaky, you're not allowed in the shop since you leave puddles everywhere")
            (out "Raccoon: I'M NOT LEAKY!!!! *blushes angrily*")
            (out "*The raccoon has an accident and his diaper leaks and leaves puddles everywhere*")
            (out "Shop Owner: Then explain the state of your diapers")
            (out "*The raccoon blushes then starts to \\sout{waddle away with his legs spread apart} \"sneak away\" hoping no one will notice what he did \\sout{even though the trail he's leaving makes it obvious}*")
            (out "*" (name-of (player-of *game*)) " laughs at the leaky raccoon*~%")
            (out "Leaky raccoon blushing angrily: What are you laughing at?")
  ...
  :lambda '(lambda (self)
            ...
            (cond
              ...
              ((< (random 12) 1)
               ...
               (out (name-of (player-of *game*)) ": Oh really? *" (name-of (player-of *game*)) " lifts up the back of the raccoon's tunic and press hard against the back of the raccoon's diaper hard.*")
               (out "*The raccoon yelps and quickly puts his paws on the back of his diaper struggling to unmush it.*")
               ...
               (if (< (random 2) 1)
                   (progn
                     ...
                     (out "*A soft hiss can be heard as the raccoon floods his diapers in a panic*")
                     (out "Diapered Raccoon Bandit: No please!!! I'll give you anything you want!!!")
                     (out (name-of (player-of *game*)) ": All your money and all your stuff")
                     (out "Diapered Raccoon Bandit: But... but... *groans* alright")
                     (out (name-of (player-of *game*)) " gets everything the raccoon is carrying except the clothes and diapers the raccoon is wearing. The raccoon then waddles off with his legs spread apart like a 5 year old who didn't make it to the toilet in time.")
...
(defevent obtain-diaper-lock-1
  ...
  :lambda '(lambda (self)
            ...
            (out (name-of (player-of *game*)) ": I'm listening")
            ...
            (out "*" (name-of (player-of *game*)) " pays up*")
            (out "Shop Owner: Thank you for your business, but before I hand you the key")
            (let ((a (cons (when (> (bladder/contents-of (player-of *game*)) (bladder/potty-dance-limit-of (player-of *game*)))
              ...
              (cond ((and (car a) (cdr a))
                     ...
                     (out (name-of (player-of *game*)) ": ACK!!! NO!!! STOP!!!")
              ...
              (out "Shop Owner: That never gets old. Here's the key as promised, enjoy " (if (car a) "sog" "mush") "butt")
              (when (cdr a)
                (out "*The Rookie Raccoon waddles in*")
                (out "Rookie Raccoon: I wish you wouldn't play that. You made me mess my diapers again")
                (out "Shop Owner: Ha, you were gonna mess yourself anyway, so it's not like it matters."))
              ...
              (out "*" (name-of (player-of *game*)) " lifts up the raccoon's tunic and squishes the front of his diaper*")
              (out (name-of (player-of *game*)) ": Seems you've had an accident too")
              (out "Shop Owner: Shut up!!! *pulls his tunic back down while blushing bright red*"))))
(defevent enter-bandits-kennel-1
  :lambda '(lambda (self)
            ...
            (let ((a nil)
              ...
              (out "Vixen: Hey! someone has entered the kennel for once!!!")
              (out "Fox: Could you let us out? We're the town's `pets' but they seemed to have forgotten about us.")
              (out "Fox: and while you're at it, could you give us... umm... you know.... *blushes heavily*")
              (out (name-of (player-of *game*)) ": A diaper change?")
              (out "*the fox nods with a blush on his face*")
              (out (name-of (player-of *game*)) ": Fine, I'll be right back, don't go anywhere.")
              (out "*the 2 foxes sit down and waits, or in their case, crouches down and waits*")
              (out "*as sitting in diapers in that state is out of the question")
              (out "*" (name-of (player-of *game*)) " enters the Bandit's shop, find a whimpering Rookie Raccoon in a toddler's dress and messy diaper being bounced on shop owner's knee*")
              (out "*At least you now know why this shop carries Toddler dresses, while they're distracted*")
              (out "*You grab a couple of adjustable diapers and a gold collar for the fox and a toddler's dress*")
              (out "*and a few of the much thicker diapers that the female raccoons wear for the vixen, you then head back to the kennel and dress the foxes and give them a diaper change*")
              (out (name-of (player-of *game*)) ": I'm back, and got you some new clothes")
              (out "Fox: Cool")
              (out "Vixen: Yay")
              (out "*the 2 wag their tails happily*")
              (out (name-of (player-of *game*)) ": Mind telling me your names?")
              (finish-output)
              ...
              (out "Vixen: And I'm " (name-of b))
              (out (name-of a) ": What's yours?")
              (out (name-of (player-of *game*)) ": I'm " (name-of (player-of *game*)) ". Now lets get you dressed")
              (out "*" (name-of a) " puts the new clothes and diapers on the foxes*~%~%"))))
(defevent get-warp-pipe-summoner-1
  ...
  :lambda '(lambda (self)
            ...
            (out "Shop Owner: The baby decided to flood his diapers while I was giving him knee bounces, so I decided to reward him with happy bouncy fun time in the baby bouncer")
            (out "Rookie: You wouldn't let me go and I couldn't hold it any longer!!!!")
            (out "Shop Owner: A likely story. Anyway, before you go, I'd like to show you something. It's based on a dream the creator of this game had.")
            (out "*The shop owner brings out a warp device and summons a warp pipe.*")
            ...
            (out (name-of (player-of *game*)) ": Why are you giving me this?")
            (out "Shop Owner: Easy way to get back to this shop, so you can buy more crap from us.")
            (out (name-of (player-of *game*)) ": Ok *grabs the device and puts it in " (if (malep (player-of *game*)) "his" "her") " inventory*")
