           ...
           (draw-card (card point)
             ...
             (case (side-of card)
               ...
               (:up (let ((text (typecase (value-of card)
                                  ...
                                  (t ""))))
                      (case (suit-of card)
                        (:diamond (draw-diamond point text))
                        (:spade (draw-spade point text))
                        (:club (draw-club point text))
                        (:heart (draw-heart point text)))))))
           (draw-row (user cards)
             (declare (type vector cards)
