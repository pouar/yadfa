        ...
        (cond
            ((member '(:watersport-limit :mudsport-limit) potty-keys
                ...
                (let ((limits (random-elt (list
                                              (cons (bladder/need-to-potty-limit c) (bowels/need-to-potty-limit c))
                                              '(nil)))))
                    (setf (watersport-limit-of c) (car limits)
                        (mudsport-limit-of c) (cdr limits))))
            ((member :watersport-limit potty-keys)
                (setf (mudsport-limit-of c) (random-elt (list (bowels/need-to-potty-limit c) nil))))
            ((member :mudsport-limit potty-keys)
                (setf (watersport-limit-of c) (random-elt (list (bladder/need-to-potty-limit c) nil)))))))
